...
// Test email content with generic FROM address
const testEmail = {
  // Use a generic email for testing
...
async function testEmailSystem() {
  try {
    ...
    console.log('Using FROM address:', testEmail.from, '(generic test address)');
    ...
    console.log('4. For Mailtrap live SMTP:');
    console.log('   - You need to use a verified domain or');
    console.log('   - Use a domain that Mailtrap allows for testing');
  }
}
