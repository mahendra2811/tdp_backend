...
// Test email content with modified FROM address
const testEmail = {
  // Use Mailtrap domain instead of thardesertphotography.com
  from: 'api@mailtrap.io', // Changed from process.env.EMAIL_FROM
...
async function testEmailSystem() {
  try {
    ...
    console.log('Using FROM address:', testEmail.from, '(modified for testing)');
